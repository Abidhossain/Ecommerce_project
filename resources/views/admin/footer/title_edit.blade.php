...
@section('content')
    <div class="row clearfix">
        <div class="col-md-8">
            <div class="tile">
                <div class="tile-body">
                    <form method="POST" action="{{ route('footer-title-update', $footer_title->id) }}">
                        @csrf
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="footer_title" name="footer_title" type="text"
                                           ...
                                           footer_title="footer_title" value="{{ $footer_title->footer_title }}"
                                           autocomplete="footer_title">
                                    @error('footer_title')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group btn-container">
                                    <button class="btn btn-success btn-sm">Update Footer Title</button>
                                </div>
                            </div>
                        </div>
                    </form>

                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($order_info as $data)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('received-order-view')}}/{{$data->id}}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Order Details"><i class="fa fa-eye"></i></a>
                                    <a href="{{url('order-cancel')}}/{{$data->id}}" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Order Cancel"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
